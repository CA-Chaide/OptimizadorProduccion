...
export const TacticalPlanFormulacionSection: React.FC = () => {
  ...
  // Inicialización segura en el cliente para evitar errores de hidratación
  useEffect(() => { 
    setMounted(true); 
  ...
  // Root Shell estable para evitar errores de hidratación
  return (
                  ...
                  <table className="w-full border-collapse text-center font-sans text-[10px]">
                    ...
                    <tbody className="divide-y divide-gray-50 font-bold">
                      {unifiedSummaryData.length === 0 ? (
                        <tr><td colSpan={7} className="py-16 text-center text-slate-200 uppercase tracking-widest italic font-black">Sin datos para la selección actual</td></tr>
                      ) : (
