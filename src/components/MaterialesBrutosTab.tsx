...
export const MaterialesBrutosTab: React.FC = () => {
    ...
    const [rowsPerPage, setRowsPerPage] = useState(ROWS_PER_PAGE_OPTIONS[1]); // Default a 50
    ...
    // Filtrado dinámico por búsqueda manual solamente
    ...
    const handlePageChange = (page: number) => {
        ...
        // Si estamos cerca del final de los datos cargados, cargar el siguiente bloque
                ...
                <div className="flex flex-col items-center justify-center py-20 bg-gray-50 border-2 border-dashed rounded-xl">
                    {isLoading ? (
                        <>
                            ...
                            <p className="text-blue-800 font-semibold">Descargando maestro de materiales...</p>
                        </>
                    ) : (
                        <>
                            <Database className="w-12 h-12 text-gray-300 mb-4" />
                            <p className="text-gray-500 text-lg">No se han cargado datos aún.</p>
                        </>
                    )}
                </div>
            )}
