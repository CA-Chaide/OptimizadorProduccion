...
import { CalendarClock, Package, ClipboardList } from 'lucide-react';
      ...
      <div className="flex items-center justify-between pb-4 border-b border-gray-100">
        <div className="flex items-center space-x-3 text-left">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 font-medium">Gestión de Órdenes y Maestro de Explosión de Materiales</p>
          </div>
        </div>
      </div>
      
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid grid-cols-2 h-10 bg-gray-50/80 p-1 rounded-xl border border-gray-100 mb-6">
          ...
          <TabsTrigger value="maestro" className="gap-2 text-[9px] font-bold uppercase transition-all data-[state=active]:bg-white data-[state=active]:shadow-sm">
            <ClipboardList className="w-3.5 h-3.5" /> Maestro Materiales
          </TabsTrigger>
        </TabsList>
