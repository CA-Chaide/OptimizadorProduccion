          ...
          <div className="flex justify-between items-center bg-gray-50/50 p-2.5 rounded-2xl border border-gray-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="text-[10px] font-black text-gray-700 uppercase text-left">
        ...
        <TabsContent value="ordenes" className="space-y-10 animate-in fade-in duration-300">
          ...
          <div className="space-y-4">
            ...
            <Card className="rounded-2xl border border-gray-100 shadow-md overflow-hidden bg-white">
              <div className="overflow-x-auto">
                <table className="w-full border-collapse text-center font-sans text-[10px]">
                  <thead className="bg-[#f8fafc] sticky top-0 z-10 text-slate-400 uppercase font-black tracking-widest border-b border-gray-100">
                    <tr>
                      <th className="px-4 py-4 border-r border-gray-50">Orden</th>
                ...
                <Card className="rounded-2xl border border-gray-100 shadow-md overflow-hidden bg-white">
                  <div className="overflow-x-auto max-h-[400px]">
                    <table className="w-full border-collapse text-center font-sans">
                      <thead className="bg-[#f1f5f9] sticky top-0 text-[10px] font-black uppercase text-slate-800 border-b border-gray-100">
                        <tr><th className="px-4 py-4 border-r border-gray-100">Material</th><th className="px-4 py-4 border-r border-gray-100 text-left">Descripción Técnica</th><th className="px-4 py-4 text-teal-700">Estándar (Min)</th></tr>
                      </thead>
                      <tbody className="divide-y divide-gray-50 text-[10px] font-bold">
                        {center.d.length === 0 ? (
                          ...
                          center.d.map((t, i) => {
                            ...
                            return (
                              <tr key={i} className="hover:bg-gray-50/50 transition-colors">
                                <td className="px-4 py-2 font-mono text-primary border-r border-gray-50 text-left">{info.code}</td>
                                <td className="px-4 py-2 text-left border-r border-gray-50 text-gray-500 uppercase truncate max-w-[280px]">{info.desc}</td>
                                <td className="px-4 py-2 font-mono text-teal-600 bg-teal-50/5">{formatNum(t.Tiempo || 0, 4)}</td>
                              </tr>
                            );
                          })
                        )}
