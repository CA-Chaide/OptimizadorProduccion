 ...
 * 
 * Revertido a la versión simplificada:
 * 1. Grupos: Filtrados por "Espuma"
 * 2. Restricciones: Pertenecientes a esos grupos
 * 3. Órdenes Provisionales: Filtradas por RespCtrlProd y ALMACEN con centrado y bordes entrecortados
 */
    ...
    <div className="p-6 md:p-8 space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="grupos">
          <Card>
            <CardHeader>
              <CardTitle>Grupos de Corte Espuma</CardTitle>
              <CardDescription>Áreas operativas identificadas que corresponden al proceso de espumas.</CardDescription>
            </CardHeader>
            <CardContent>
              {grupos.length === 0 ? (
                <div className="text-center py-12 text-gray-400 border-2 border-dashed rounded-lg">
                  No se encontraron grupos relacionados con Espumas.
                </div>
              ) : (
        ...
        <TabsContent value="restricciones">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Reglas de responsable y almacén aplicables al área de espumas.</CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardContent>
              {ordenesFiltradas.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-16 text-gray-500 bg-gray-50 rounded-lg border-2 border-dashed">
                  ...
                  <p className="font-medium">No se detectaron órdenes bajo los parámetros actuales de Corte Espuma.</p>
                </div>
              ) : (
